...
- **Dashboard center workspaces**: Personal Memory and Project Knowledge now have separate, clearer center-page layouts with page context, recent-use cards, category navigation, readable registries, and application or evidence inspection without changing the global navigation shell.
