...
- **Native parent-child changes**: Native can coordinate a large change through named child changes with dependency and acceptance coverage, run ready children in parallel worktrees, merge them into the parent branch in order, and verify the final integrated result against the parent acceptance criteria.
