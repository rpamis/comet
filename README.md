...
> - **A unified three-pane Dashboard**: Inspect Native and Classic progress, Git worktrees, acceptance results, and archives; [observe nodes, evidence, and artifacts from Comet Any-generated Skills](docs/dashboard-comet-any.md), and manage Personal Memory, Project Knowledge, and plugin settings.
