...
- `acceptance` / `children` / `readyChildren` / `nextPageArgs`: the acceptance summary, parent child projections, currently startable children, and command for the next page.
