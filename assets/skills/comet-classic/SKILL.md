---
name: comet-classic
description: "Use when the user explicitly chooses the permanent Comet Classic workflow to start or resume a change through OpenSpec and Superpowers."
---
...
- Upgrade to full `/comet-classic` (use `node "$COMET_STATE" transition <name> preset-escalate` to legally rewind to the design phase, supplementing Design Doc and Superpowers plan)
