    ...
    const variants = [
      ...
      },
      {
        ...
        required: [
          ...
          'ready question set',
          'decision tree of user-visible results',
          'form the current frontier',
          'all prerequisite decisions settled',
          'does not depend on another question in the same round',
          'other frontier questions must still be asked in the current round',
          'must start independent fact investigations in parallel',
