    ...
    const variants = [
      {
        ...
        required: [
          ...
          '多会话协作（推荐）',
          '单会话推进',
          '不得自动改用 subagent 或单会话推进',
          '只有选择多会话协作且平台可以管理独立会话',
          '需求文字长、任务条目多本身不能触发拆分',
      ...
      },
      {
        ...
        required: [
          ...
          'do not automatically switch to subagents or single-session progression',
          'only when multi-session coordination was selected and the platform can manage independent sessions',
