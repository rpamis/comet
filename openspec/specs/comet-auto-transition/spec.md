...
Define how Comet records and applies a per-Change automatic transition switch so users can opt into manual phase continuation without leaving the state machine stale.
